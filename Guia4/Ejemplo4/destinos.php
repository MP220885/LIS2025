...
<body>
<header ><nav class="navbar navbar-light bg-warning ">
...
<div class="container">
<?php
function createList($lista, $tipo="ul"){$ullist = "";
    $ollist = "";
    switch($tipo):
    case "ul":
   ...
   href=\"javascript:void(0)\">$key => $value</a></li>\n";
    ...
    print $ullist;
    break;
    case "ol":$ollist .= "<article id=\"cities\">\n";
...
if(isset($_POST['submit'])):
    ...
    else:print "<p>El procesamiento del formulario requiere que se haya
