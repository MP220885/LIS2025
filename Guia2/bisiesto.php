...
<body class="bg-light">
 ...
 <?php
$currentYear = date('Y');
if (!isset($_POST['enviar'])): ?><form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST"
    ...
    mt-3'>El año $year es bisiesto.</div>";
        ...
        || !Number.isInteger(Number(yearInput))) {alert(`Por favor, ingrese un año válido mayor a 1900 y menor o igual
a ${currentYear}.`);
 return false;
 }
 return true;
