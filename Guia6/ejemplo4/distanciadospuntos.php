...
die("class/{$className}.class.php No existe en el proyecto");
 ...
 $coord1->x = $x1;
 $coord1->y = $y1;
 //Definiendo las coordenadas del segundo punto$coord2->x = $x2;
 $coord2->y = $y2;
...
-->
 <!-- Coordenada 1 (x1,y1) --><label>Coordenada 1 (x1,y1): </label>
 <div class="field">
...
id="perimetro" /><input type="reset" value="Restablecer" class="send" name="reset" id="area" />
 </form>
 </div>
</div>
<?php
