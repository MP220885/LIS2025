...
if(isset($_POST['enviar'])){
    ...
    //Creando instancia de la clase empleado
    $empleado1 = new ejercicio2();
    $empleado1->obtenerSalarioNeto($name, $apellido, $sueldo, $numHorasExtras, $pagohoraextra, $prestamo);
}
else {
?>
<section class="container"><nav class="navbar navbar-dark bg-primary text-white">
...
maxlength="6" class="inputField form-control" /><br />
 ...
 <div class="form-group">
<label for="prestamo">Préstamo a descontar ($):</label>
