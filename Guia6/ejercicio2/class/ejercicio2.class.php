...
calculados.</p>";
 $backlink = "<a class=\"a-btn\" href=\"ejercicio2.php\">";
 ...
 function obtenerSalarioNeto($nombre, $apellido, $salario, $horasextras, $pagoxhoraextra=0.0, $prestamo=0.0){
    ...
    // Calcular descuentos de ISSS y AFP
    ...
    // Cálculo del salario con los descuentos de ISSS y AFP
    ...
    // Ahora se incluye el descuento por préstamo
    $this->prestamo = $prestamo;

    // Calculando el sueldo líquido considerando el préstamo
...
colspan=\"2\"><h4>Descuentos</h4></td></tr>";
 ...
 $tabla .= "<tr><td>Préstamo a descontar: </td>";
$tabla .= "<td>$ " . number_format($this->prestamo, 2, '.', ',') . "</td></tr>";

 $tabla .= "<tr><td>Total descuentos: </td>";$tabla .= "<td>$ " . number_format($this->isss + $this->afp + $this->renta, 2, '.',
 ',') . "</td></tr>";
